...
{
    public class CustomExceptionFilterIOCAttribute : ExceptionFilterAttribute
    {
        #region Identity, use for logging when error

        private readonly ILogger<CustomExceptionFilterNewAttribute> _logger;

        public CustomExceptionFilterIOCAttribute(ILogger<CustomExceptionFilterNewAttribute> logger)
        {
            this._logger = logger;
        }
