...
namespace P03.DotNetCoreMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            #region Add service IOC, can move  to ConfigureContainer or  CustomAutofacModule
            ...
            //services.AddTransient<ITestServiceE, TestServiceE>();//move to Autofac configure: ConfigureContainer
