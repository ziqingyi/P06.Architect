...
namespace P04.DataStructureAlgorithm.DataStructure
{
    public class I_SkipListDemo
    {
        ...
        public static void Show()
        {
            ...
            {
                skipList.Add(arr[i], arr[i]);
            }

            Console.WriteLine("*******item iterate: ");
            foreach (var item in skipList)
            {
                Console.WriteLine($"item key and value：{item.Key} {item.Value}");
            }
            ...
            skipList.TryGetValue(20, out int int20);
        }
