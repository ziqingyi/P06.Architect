...
namespace P06.Architect.AspNetCoreCustom
{
    ...
    public static class UseMiddlewareExtensionsCustom
    {
        ...
        private static readonly MethodInfo GetServiceInfo = typeof(UseMiddlewareExtensionsCustom).GetMethod(nameof(GetService), BindingFlags.NonPublic | BindingFlags.Static)!;
